 ...
 */
export declare function assignBookmarkIds(root: PDFNode): void;
/**
 ...
 */
export declare function emitBookmarks(doc: any, nodes: PDFNode[], itemById: Map<number, any>, parentItem?: any): void;
