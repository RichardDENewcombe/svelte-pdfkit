 ...
 */
function drawRoundedRectPath(doc, x, y, w, h, tl, tr, br, bl) {
 ...
 */
function strokeCutBorderPath(doc, x, y, w, h, tl, tr, br, bl, cutTop, cutBottom) {
    if (cutTop && cutBottom) {
...
function drawNodes(doc, nodes, pageNumber = 1, totalPages = 1, pageOf = () => undefined) {
 ...
 */
export function renderPDF(pages, resources = [], metadata = {}, pageOf = () => undefined) {
