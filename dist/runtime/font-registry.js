 ...
 */
export function resolveFont(family, weight, style) {
...
export function isBuiltinVariant(variant) {
 ...
 */
export function isFamilyAvailable(family, weight, style) {
 ...
 */
export function resolveFontStack(fontFamily, weight, style) {
