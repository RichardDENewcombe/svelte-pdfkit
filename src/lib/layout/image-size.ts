...
function isPng(b: Buffer): boolean {
	...
	return (
		b.length >= 24 && b.readUInt32BE(0) === 0x89504e47 && b.readUInt32BE(4) === 0x0d0a1a0a
	);
}
...
function svgSize(b: Buffer): ImageDimensions | null {
...
export function imageAspectRatio(buffer: Buffer): number | null {
